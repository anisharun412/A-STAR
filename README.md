...
n,e = map(int,input("Enter No.of NODES & EDGES like (5 6) : ").split())
for i in range(e):
...
<img width="1919" height="666" alt="image" src="https://github.com/user-attachments/assets/f828f6da-671a-48df-a416-d5a5871d2822" />

<img width="1919" height="406" alt="image" src="https://github.com/user-attachments/assets/d8c3a43c-eea8-4a9a-ac9c-8757a906dc6d" />
